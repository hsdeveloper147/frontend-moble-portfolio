...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    //getElementById used instead of querySelector
    switch(size) {
      case "1":
  ...
  //Deleted determineDx function which was a cause of Forced Reflow and Modified changePizzaSizes function as below
...
//Moved initialisation of pizzaDiv outside the for loop
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //Made a varibale movingPizza outside the forloop and getElementById used instead of querySelector

  var movingPizza = document.getElementById("movingPizzas1");
  //Changed the number of loop iterations from 200 to 24 (multiple of 8 i.e no. of columns)
  for (var i = 0; i < 24; i++) {
